...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "bluebell",
            "url": "https://github.com/Keviniscool-boy?tab=repositories",
            "email": "raotao29@gmail.com"
        },
        "license": {
            "name": "Apache 2.0",
        ...
        "/posts2/": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "排序方式：time 按时间（默认）| score 按热度",
                        "name": "order",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "models.VoteData": {
            ...
            "properties": {
                "direction": {
                    "description": "投票方向 1赞成 0取消 -1反对（不能加 required，0 是合法值）",
                    "type": "string",
                    "enum": [
                        1,
                        0,
